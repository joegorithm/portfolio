...
function renderProjects() {
    document.querySelectorAll(".project-tiles").forEach((container) => {
        const raw = container.dataset.projects || "";
                ...
                <div class="project-tile ui-element" data-hover-effect>
                    ...
                    <div class="project-main">
                        <div class="project-header">
                            <a href="/projects/${proj.id}" class="project-logo-link">
                                <img src="${proj.logo}" class="project-logo" alt="${proj.title} logo">
                            </a>
                            <div class="project-header-information">
                                <a href="/projects/${proj.id}" class="project-title">${proj.title}</a>
                                <p class="project-type">${proj.category}</p>
                                <div class="time-ago-status tooltip-element">
                                    <div class="time-ago-icon"></div>
                                    <span class="time-ago-date" data-started="${proj.started}" ${proj.completed ? `data-completed="${proj.completed}"` : ""}></span>
                        ...
                        <div class="project-options">
                            <a href="/projects/${proj.id}" class="project-options-button tooltip-element">
                                <div class="project-options-icon">
                                    <svg width="1.4rem" height="1.4rem" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>
                                </div>
                                <span class="tooltip tooltip-button">Details</span>
                            </a>
                            ${proj.github ? `
                            <a href="${proj.github}" target="_blank" class="project-options-button tooltip-element">
                                <div class="project-options-icon">
                            ...
                            <a href="${proj.url}" target="_blank" class="project-options-button tooltip-element">
                                <div class="project-options-icon">
                                    <svg width="1.4rem" height="1.4rem" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32l82.7 0L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3l0 82.7c0 17.7 14.3 32 32 32s32-14.3 32-32l0-160c0-17.7-14.3-32-32-32L320 0zM80 32C35.8 32 0 67.8 0 112L0 432c0 44.2 35.8 80 80 80l320 0c44.2 0 80-35.8 80-80l0-112c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 112c0 8.8-7.2 16-16 16L80 448c-8.8 0-16-7.2-16-16l0-320c0-8.8 7.2-16 16-16l112 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L80 32z"/></svg>
                                </div>
            ...
            <div class="project-details-header project-details-header-${project.id}">
                ...
                <div class="project-details-facts">
                    ...
                    <div class="project-details-options">
                        ...
                        <a href="/contact?category=project-feedback&project=${project.id}" class="project-details-options-button project-details-options-button-feedback">
